...
import com.android.tripnhome.BaseRecyclerViewFastScrollBar.FastScrollFocusApplicator;
import com.android.tripnhome.BaseRecyclerViewFastScrollBar.FastScrollFocusable;
import com.android.tripnhome.BubbleTextView;
...
public class AllAppsGridAdapter extends RecyclerView.Adapter<AllAppsGridAdapter.ViewHolder> {
    ...
    public AllAppsGridAdapter(Launcher launcher, AlphabeticalAppsList apps,
        ...
        mAllAppsTextColor = res.getColor(R.color.quantum_panel_text_color_dark);
        ...
        int sectionTextColorId = R.color.all_apps_grid_section_text_color_dark;
    ...
    public void setGridTheme(int gridTheme) {
        ...
        mAllAppsTextColor = mLauncher.getColor(R.color.quantum_panel_text_color_dark);

        int mPredictedAppsDividerColorId = R.color.drawer_divider_dark;
