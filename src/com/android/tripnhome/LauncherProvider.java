...
import com.android.tripnhome.AutoInstallsLayout.LayoutParserCallback;
...
import com.android.tripnhome.config.ProviderConfig;
...
public class LauncherProvider extends ContentProvider {
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper implements LayoutParserCallback {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            switch (oldVersion) {
                // The version cannot be lower that 12, as TripNHome never supported a lower
                // version of the DB.
                case 12: {
                ...
                case 16: {
                    ...
                    Log.w(TAG, "Found pre-11 TripNHome, preparing update");
